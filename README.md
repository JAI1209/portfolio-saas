...
Production-ready Portfolio SaaS with Next.js App Router, Express + MongoDB, and JWT-based admin workflows.

## Suggested Commit Message (Final Push)
`feat: finalize auth, admin workflow, UI polish, and docs`

## Screenshots
- Home page: (add screenshot)
- Admin dashboard: (add screenshot)
- Portfolio detail: (add screenshot)
